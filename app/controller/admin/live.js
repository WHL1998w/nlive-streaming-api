		    ...
		    table: {
		        ...
		        columns: [{
		            ...
		            render(item){
						...
						<a class="avatar mr-2"><img class="rounded-circle" src="${item.cover}"></a>
				...
				},
				{
					...
					render(item){
						...
						return ` <div class="actions btn-group btn-group-sm">
					   ...
					   <a 	@click="openInfo('/admin/live/gift/${item.id}','礼物记录')" class="btn btn-sm bg-purple text-white">礼物记录</ a>
						...
						class="btn btn-sm bg-success text-white">弹幕记录</ a>
						 <a 	@click="openInfo('/admin/live/delete/${item.id}')" 
